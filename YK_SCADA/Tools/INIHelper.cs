...
namespace YK_SCADA.Tools
{
    public static class INIHelper
    {
        ...
        {
            WritePrivateProfileString("local", Key, Value, App.inipath);
        }
        /// <summary>
        /// 读取INI数据
        /// </summary>
        ...
        public static string Read(string Key)
        {
            ...
            int i = GetPrivateProfileString("local", Key, "", Buffer, Buffer.GetUpperBound(0), App.inipath);
        ...
        {
            byte[] Buffer = new byte[255];
            int i = GetPrivateProfileString(Section, Key, "", Buffer, Buffer.GetUpperBound(0), path);
            string s = Encoding.UTF8.GetString(Buffer, 0, i);
            return s;
        }
        ...
        {
            byte[] Buffer = new byte[255];
            int i = GetPrivateProfileString(Section, Key, "", Buffer, Buffer.GetUpperBound(0), App.inipath);
            string s = Encoding.UTF8.GetString(Buffer, 0, i);
            return s;
        }
        #endregion
        ...
        public static string ReadString(string sectionName, string keyName, string defaultValue, string path)
        {
            ...
            int i = GetPrivateProfileString(sectionName, keyName, "", Buffer, Buffer.GetUpperBound(0), path);
            string s = Encoding.UTF8.GetString(Buffer, 0, i);
            return s;
